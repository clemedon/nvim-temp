...
function! functions#StripTrailingSpaces()
...
"   toggle colors
function! functions#ColorSwitch(clight, cdark)
...
"   clang-format
function! functions#ClangFormat()
...
function! functions#Eatchar(pat)
